...
```
powershell -Command "(Invoke-WebRequest -Uri https://raw.githubusercontent.com/crmaxx/zlib.install/master/install.bat -OutFile install_zlib.bat)"; ./install_zlib.bat; del install_zlib.bat
```
